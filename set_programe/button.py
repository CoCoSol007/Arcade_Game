...
class Button(pygame.sprite.Sprite) :
    ...
    def __init__(self, style, co,path) :
        ...
        if style == "start" :
            ...
            self.image = pygame.image.load("set/re-start.png")
            self.image = pygame.transform.scale(self.image,(128, 128))

        elif style == "menu" : 
            self.image = pygame.image.load("set/menu.png")
            self.image = pygame.transform.scale(self.image,(256, 200))
        elif style == "settings" : 
            self.image = pygame.image.load("set/settings.png")
            self.image = pygame.transform.scale(self.image,(256, 100))
        elif style == "Plus" : 
            self.image = pygame.image.load("set/Son_Plus.png")
            self.image = pygame.transform.scale(self.image,(128,128))
        elif style == "Moin" : 
            self.image = pygame.image.load("set/Son_Moin.png")
            self.image = pygame.transform.scale(self.image,(128,128))
